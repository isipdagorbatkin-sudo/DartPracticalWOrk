...
void main() {
  // 1
  var person = Person('Денис');
  var mug = Mug();
  person.drinkFromMug(mug, 67);
  
  // 2
  var cabinet = Cabinet();
  cabinet.putItem('Ноутбук');
  cabinet.putItem('Чешки');
  cabinet.showItems();
  cabinet.takeItem('Сандали');
  
  // 3
  var barbell = Barbell(100);
  barbell.addWeightLeft(Weight(67));
  barbell.addWeightRight(Weight(52));
  
  // 4
  var converter = CurrencyConverter();
  print(converter.convert(67, 'USD', 'RUB'));
